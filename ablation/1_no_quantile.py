"""ABLATION: Use squared_error instead of quantile loss."""
from shared import *
...
for p in PORTFOLIOS:
    ...
    for met in ['Call Volume','CCT']:
        ...
        # CHANGE: squared_error instead of quantile
        gb=HistGradientBoostingRegressor(loss='squared_error',max_iter=500,max_depth=6,learning_rate=0.05,min_samples_leaf=10,random_state=42)
...
print(f"\n>> NO QUANTILE (squared_error instead)")
